...
for (const name of ['index.html','app.html','review-brief-260916.html','css','js','fonts','data','assets','docs','SHA256SUMS.txt']) await cp(root+name,dist+name,{recursive:true});
